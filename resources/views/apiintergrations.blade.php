...
<body>
    <div class="hero">
        <h1>Grow Your Business with Payment Integrations</h1>
        <p>Seamlessly integrate Mpesa and other payment options into your website.</p>
    </div>
    <div class="container">
        <h2>Payment <span style="color: blue;">Integrations</span></h2>
        <p>Mpesa is one of the best ways people make transactions in Kenya. Integrate Mpesa into your online business for faster transactions with your customers.</p>
        ...
        <form>
            ...
            <label>Your Company/ Business Name</label>
            ...
            <textarea rows="4" placeholder="Enter your request details..."></textarea>
            
            <div class="consent">
                <input type="checkbox" required>
                <label>I consent to have this website store my submitted information so they can respond to my inquiry</label>
            </div>

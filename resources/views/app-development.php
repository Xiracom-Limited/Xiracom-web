...
<body>
  <section class="app-development">
    <div class="header-section">
      <img src="phone-mockup.png" alt="App Development Mockup" class="mockup-image">
      <h1>App Development</h1>
      <p>We create custom web applications, combining innovation, functionality, and expert development to bring your vision to life.</p>
    </div>
  ...
  <section class="why-choose-us">
    ...
    <div class="content">
      <div class="description">
        <p>We are committed to delivering cutting-edge solutions that meet your needs and exceed your expectations. Here is why you should partner with us:</p>
      </div>
      <div class="benefits">

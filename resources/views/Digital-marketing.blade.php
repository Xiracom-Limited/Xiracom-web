        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="audience-stats">
                    <div class="audience-count">1.9k</div>
                    <div class="audience-label">Total Audience</div>
                </div>
                <div class="project-stats">
                    <div class="project-count">5.7k</div>
                    <div class="project-label">Complete Project</div>
                </div>
                </div>
                <a href="#" class="btn btn-warning">Explore</a>
            </div>

             <!-- Cards column  starts here -->
            <div class="col-md-6">

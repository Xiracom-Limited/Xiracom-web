...
<nav class="navbar w-100 navbar-expand-lg navbar-light color custom-nav" style="position:fixed;z-index:2000;">
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      ...
      <a class="dropdown-item"  href="./jobs&internship">Jobs & Internships</a>
      ...
      <li class="nav-item">
        <a class="nav-link fw-bolder color-text" href="./login">LOGIN</a>
      </li>
      <li class="nav-item">
        <a class="nav-link fw-bolder color-text" href="./register">GET STARTED</a>
      </li>
    </ul>
  <div class="me-5 contact-nav-bar" style="color:#ffff;">
